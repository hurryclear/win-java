...
public class WaitAndNotifyCigaretteStep1 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        new Thread(() -> {
            ...
            synchronized (room) {
                ...
                // 5. t1 wakes up and check cigarette, since cigarette has been delivered, t1
                // begins to work
                log.debug("do you have cigarette? [{}]", hasCigarette);
                if (hasCigarette) {
        ...
        // 4. main thread sleep 1s and will deliver the cigarette and now the hasCigarette=true
        sleep(1000);
